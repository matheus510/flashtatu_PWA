...
const vueStarterRepo: string = 'https://api.github.com/repos/matheus510/flashtatu_pwa';
...
async function update() {
  ...
  diffFiles.forEach((diffFile: IFile) => {
    ...
    const url: string = `https://raw.githubusercontent.com/matheus510/flashtatu_pwa/master/${diffFile.filename}`;
